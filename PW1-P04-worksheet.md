...
| PW1-P04-E07 | Checkpoint Git | Commit implementasi awal `1a8dd39` — `feat: tambah form kontak aksesibel dan preview`; commit worksheet awal `99367f0` — `docs: catat evidence praktikum P04`; checkpoint preferensi kontak P04-04 `6fb6a66` — `feat: tambah preferensi kontak P04`. | Lulus |
